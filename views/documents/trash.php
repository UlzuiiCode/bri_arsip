...
<div class="space-y-5 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= BASE_URL ?>/index.php?page=documents.empty_trash"
               onclick="return confirm('PERINGATAN: Semua dokumen di tempat sampah akan dihapus PERMANEN. Tindakan ini tidak bisa dibatalkan. Lanjutkan?')"
               class="inline-flex items-center gap-2 rounded-xl bg-red-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-500 transition-all">
